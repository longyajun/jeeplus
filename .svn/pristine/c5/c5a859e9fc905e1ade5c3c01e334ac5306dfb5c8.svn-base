...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="uipAgent" action="${ctx}/agent/uipAgent/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>代理名称：</label></td>
					<td class="width-35">
